...
const ALL_ISSUES = [
  {
    id: 1, category: "E", categoryLabel: "환경",
    title: "온실가스 배출 관리",
    desc: "Scope 1·2·3 배출량 측정 및 감축 전략",
    indicators: ["GRI 305-1 직접 배출량", "GRI 305-2 간접 배출량", "GRI 305-3 기타 간접 배출량"],
    years: [2023, 2024],
  },
  {
    id: 2, category: "E", categoryLabel: "환경",
    title: "에너지 효율화",
    desc: "에너지 사용량 관리 및 재생에너지 전환",
    indicators: ["GRI 302-1 에너지 소비량", "GRI 302-4 에너지 절감량"],
    years: [2024],
  },
  {
    id: 3, category: "E", categoryLabel: "환경",
    title: "수자원 관리",
    desc: "용수 취수·방류·재사용 체계 구축",
    indicators: ["GRI 303-3 용수 취수량", "GRI 303-4 용수 방류량"],
    years: [2023],
  },
  {
    id: 4, category: "E", categoryLabel: "환경",
    title: "폐기물 저감",
    desc: "폐기물 발생 억제 및 재활용률 향상",
    indicators: ["GRI 306-3 폐기물 발생량", "GRI 306-4 폐기물 전환량"],
    years: [2023, 2024],
  },
  {
    id: 5, category: "S", categoryLabel: "사회",
    title: "산업 안전 및 보건",
    desc: "산업재해 예방과 안전관리 체계 강화",
    indicators: ["GRI 403-9 산업재해율", "GRI 403-10 직업병 발생률"],
    years: [2024],
  },
  {
    id: 6, category: "S", categoryLabel: "사회",
    title: "인적자원 개발",
    desc: "임직원 역량 개발 및 교육 훈련 체계",
    indicators: ["GRI 404-1 교육 훈련 시간", "GRI 404-2 성과 향상 프로그램"],
    years: [2023],
  },
  {
    id: 7, category: "S", categoryLabel: "사회",
    title: "다양성 및 포용",
    desc: "성별·연령·장애 등 다양성 확대",
    indicators: ["GRI 405-1 이사회 다양성", "GRI 405-2 임금 비율"],
    years: [2023, 2024],
  },
  {
    id: 8, category: "S", categoryLabel: "사회",
    title: "공급망 관리",
    desc: "공급업체 ESG 실사 및 리스크 관리",
    indicators: ["GRI 308-1 환경 평가 공급업체", "GRI 414-1 사회 평가 공급업체"],
    years: [],
  },
  {
    id: 9, category: "G", categoryLabel: "지배구조",
    title: "이사회 독립성",
    desc: "이사회 구성·다양성·의사결정 투명성",
    indicators: ["GRI 2-9 이사회 구성", "GRI 2-10 이사회 후보 선정"],
    years: [2024],
  },
  {
    id: 10, category: "G", categoryLabel: "지배구조",
    title: "윤리 경영",
    desc: "반부패·준법·윤리규정 운영",
    indicators: ["GRI 205-2 반부패 교육", "GRI 205-3 확인된 부패 사례"],
    years: [2023, 2024],
  },
  {
    id: 11, category: "G", categoryLabel: "지배구조",
    title: "정보 보안",
    desc: "사이버보안 및 개인정보 보호 체계",
    indicators: ["GRI 418-1 개인정보 침해 건수"],
    years: [2023],
  },
  {
    id: 12, category: "G", categoryLabel: "지배구조",
    title: "리스크 관리",
    desc: "ESG 리스크 식별·평가·대응 체계",
    indicators: ["GRI 2-12 최고 거버넌스 기구 역할"],
    years: [],
  },
];
        ...
        <main style={s.main}>
          ...
          <div style={s.pageHeader}>
            ...
            <div style={s.headerStats}>
              <div style={s.statBox}>
                <span style={s.statNum}>{ALL_ISSUES.length}</span>
                <span style={s.statLabel}>전체 이슈</span>
              </div>
              <div style={s.statBox}>
                <span style={s.statNum}>{ALL_ISSUES.filter(i => i.category === "E").length}</span>
                <span style={{ ...s.statLabel, color: "#16a34a" }}>E</span>
              </div>
              <div style={s.statBox}>
                <span style={s.statNum}>{ALL_ISSUES.filter(i => i.category === "S").length}</span>
                <span style={{ ...s.statLabel, color: "#2563eb" }}>S</span>
              </div>
              <div style={s.statBox}>
                <span style={s.statNum}>{ALL_ISSUES.filter(i => i.category === "G").length}</span>
          ...
          <div style={s.listWrap}>
            ...
            {filteredIssues.length === 0 ? (
              ...
              filteredIssues.map((issue, idx) => {
                const c = CATEGORY_COLOR[issue.category];
                return (
                  <div
                    key={issue.id}
                    style={{
                  ...
                  return (
                    <div key={issue.id} style={{ borderBottom: "1px solid #f0ede8" }}>
                      ...
                      >
                        ...
                        <div style={{ flex: 1 }} onClick={() => setExpandedIssue(isExpanded ? null : issue.id)}>
