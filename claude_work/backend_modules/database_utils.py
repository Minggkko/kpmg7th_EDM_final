...
# .env 파일 탐색: 프로젝트 루트 또는 DB_postgresql 폴더 순으로 확인
# 구조: kpmg7th_EDM_final/claude_work/backend_modules/database_utils.py
_ROOT = Path(__file__).resolve().parent.parent.parent  # kpmg7th_EDM_final/
_ENV_PATHS = [
    _ROOT / ".env",
    _ROOT / "DB_postgresql" / ".env",
]
