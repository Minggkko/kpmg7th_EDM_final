...
def verify_evidence_data(
    ...
    try:
        ...
        # ── STEP 3: standardized_data 전체 캐시 (Python-side 매칭용, v_status=1만) ─────────
        std_rows = (
        ...
        # (source_name, metric_name, reporting_date) → record 인덱싱
        std_index: dict[tuple, dict] = {
            (r["source_name"], r["metric_name"], r["reporting_date"]): r
            for r in std_rows
        }
